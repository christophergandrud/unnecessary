...
Point estimates from simulated QI distributions are measures of central tendency of these distributions. To find point estimates from them, it is important to use the most appropriate measure of central tendency given these distributions' characteristics.

Many QI distributions are by construction asymetric, being skewed and/or bounded (e.g. by 0 and 1 for predicted probabilities). As in any other context, when summarising the central tendency of such distributions the median is a more accurate measure of central tendency than the mean.
